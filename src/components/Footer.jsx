...
const LINK_COLUMNS = [
  ...
  },
  {
    ...
    links: [
      ...
      { href: '#online', label: 'Online banking' },
  ...
  return (
    <footer className="site-footer" role="contentinfo">
          ...
          <a href="/" className="footer-logo-wrap">
            {!logoFailed ? (
              ...
              <span className="footer-logo-fallback">
                ...
                <span className="footer-logo-text">Rawbank</span>
              </span>
            )}
          </a>
          <p className="footer-desc">
            Rawbank serves individuals and businesses with modern banking, strong security, and a
      ...
      <div className="footer-bottom">
        <p className="footer-copy">&copy; {year} Rawbank. All rights reserved.</p>
